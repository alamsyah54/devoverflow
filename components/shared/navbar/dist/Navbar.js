...
var Navbar = function () {
  return react_1["default"].createElement(
    ...
    {
      className:
        "flex-between background-light900_dark200 fixed z-50 w-full gap-5 p-6 max-sm:shadow-lg max-sm:shadow-primary-500/10 sm:px-12",
    },
    ...
    react_1["default"].createElement(
      ...
      react_1["default"].createElement(
        nextjs_1.SignedIn,
        null,
        react_1["default"].createElement(nextjs_1.UserButton, {
          afterSignOutUrl: "/",
          appearance: {
            elements: {
              avatarBox: "h-10 w-10",
