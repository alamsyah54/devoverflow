...
const RenderTag_1 = require("../shared/RenderTag");
const Metric_1 = require("../shared/Metric");
const utils_1 = require("@/lib/utils");
const QuestionCard = function (_a) {
  const _id = _a._id;
  const title = _a.title;
  const tags = _a.tags;
  const author = _a.author;
  const upvotes = _a.upvotes;
  const views = _a.views;
  const answers = _a.answers;
  const createdAt = _a.createdAt;
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            ...
            {
              className:
                "subtle-regular text-dark400_light700 line-clamp-1 flex px-2 lg:hidden",
            },
            utils_1.getTimestamp(createdAt),
          ),
        ),
        react_1.default.createElement(
          link_1.default,
          ...
          react_1.default.createElement(
            ...
            {
              className:
                "h3-semibold base-semibold text-dark200_light900 line-clamp-1 flex-1",
            },
            title,
          ),
        ),
