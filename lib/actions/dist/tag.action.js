...
exports.getTopInteractedTags = getTopInteractedTags;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    mongoose_1.connectToDatabase();
                    return [4 /*yield*/, tag_model_1["default"].find({})];
                case 1:
                    tags = _a.sent();
                    return [2 /*return*/, { tags: tags }];
                case 2:
                    error_2 = _a.sent();
                    console.log("====================================");
                    console.log(error_2);
